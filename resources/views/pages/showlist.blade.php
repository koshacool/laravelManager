...
@section('content')
    ...
    <div class="contactsList" id="contactList">
        <form method="post" action="/showlist">
            {{ csrf_field() }}
            <input type="hidden" name="mainSortColumn" id="mainSortColumn" value=<?= $sortValues['mainSortColumn'] ?>>
                            ...
                            <div class="actionsBottom">
                                ...
                                <div class="actionDelete">
                                    <div class="deleteButton">
                                        <div>
                                            <a href="/contact/view/{{ $contact->id }}">
                                                <span>view</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="xButton">
                                        <div>
                                            <a href="/contact/confirm/{{ $contact->id }}">
                                                <span>X</span>
                                            </a>
                                        </div>
                                    </div>
